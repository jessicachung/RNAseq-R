...
Relative log expression (RLE) plots are a tool for visualising unwanted variation in high-dimensional expression data [@Gandolfo2018]. We can assess if normalisation has been successful using RLE plots. 
